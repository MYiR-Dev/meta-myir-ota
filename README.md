...
## Overview
- This layer is used to demonstrate SW update OTA use case on STM32MP15-DK2 and STM32MP15-EV1
...
## 1. Documentation
- [STM32MP1-ecosystem-v4.0.0 Release note](https://wiki.st.com/stm32mpu/wiki/STM32_MPU_OpenSTLinux_release_note_-_v4.0.0)
